...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/artifacts/boundary/solidity_verifier_sample}"
...
OPTIMIZED_PROFILE="${OPTIMIZED_PROFILE:-strict_parity}"

mkdir -p "$OUTPUT_DIR"
echo "[boundary] running solidity verifier differential sample"
