...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/artifacts/crypto/curve_sample}"
...
IMPLEMENTATION_PROFILE="${IMPLEMENTATION_PROFILE:-strict_validation}"

mkdir -p "$OUTPUT_DIR"
echo "[crypto] running curve operation sample campaign"
...
echo "[crypto] curve sample report: $OUTPUT_JSON"
