...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/artifacts/boundary/cross_component_bug_probe}"
...
VERIFIER_PROFILE="${VERIFIER_PROFILE:-weak_mismatch_acceptance}"

mkdir -p "$OUTPUT_DIR"
echo "[boundary] running cross-component bug probe"
