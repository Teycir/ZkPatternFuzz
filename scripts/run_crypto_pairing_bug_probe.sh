...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/artifacts/crypto/pairing_bug_probe}"
...
IMPLEMENTATION_PROFILE="${IMPLEMENTATION_PROFILE:-weak_subgroup_checks}"

mkdir -p "$OUTPUT_DIR"
echo "[crypto] running pairing bug probe"
...
echo "[crypto] pairing bug probe report: $OUTPUT_JSON"
