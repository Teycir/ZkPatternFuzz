...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/artifacts/boundary/serialization_bug_probe}"
...
VERIFIER_PROFILE="${VERIFIER_PROFILE:-lenient_legacy}"

mkdir -p "$OUTPUT_DIR"
echo "[boundary] running serialization bug probe"
